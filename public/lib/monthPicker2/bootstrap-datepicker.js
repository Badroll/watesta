    ...
    d.prototype = {
            ...
            if (!this.isInline) {
                ...
                this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"),
                    "auto" !== this.o.orientation.x
                        ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x), "right" === this.o.orientation.x && (u -= e - c))
                        : (this.picker.addClass("datepicker-orient-left"), d.left < 0 ? (u -= d.left - a) : d.left + e > s && (u = s - e - a));
                var f,
                    g,
                    v = this.o.orientation.y;
                "auto" === v && ((f = -r + d.top - i), (g = r + n - (d.top + l + i)), (v = Math.max(f, g) === g ? "top" : "bottom")),
            ...
            if (this._allow_update) {
                ...
                arguments.length
                    ? (t.each(
                      ...
                      (a = !0))
                    : ((i = this.isInput ? this.element.val() : this.element.data("date") || this.element.find("input").val()), (i = i && this.o.multidate ? i.split(this.o.multidateSeparator) : [i]), delete this.element.data().date),
                    (i = t.map(
                        i,
                        t.proxy(function (t) {
        ...
        getClassNames: function (e) {
            var i = [],
                ...
                n = new Date();
            return (
                e.getUTCFullYear() < a || (e.getUTCFullYear() === a && e.getUTCMonth() < s) ? i.push("old") : (e.getUTCFullYear() > a || (e.getUTCFullYear() === a && e.getUTCMonth() > s)) && i.push("new"),
        ...
        fill: function () {
            ...
            for (var m, y = []; p.valueOf() < D; ) {
                ...
                if (((m = this.getClassNames(p)), m.push("day"), this.o.beforeShowDay !== t.noop)) {
                    ...
                    T === e ? (T = {}) : "boolean" == typeof T ? (T = { enabled: T }) : "string" == typeof T && (T = { classes: T }),
        ...
        updateNavArrows: function () {
            if (this._allow_update) {
                ...
                switch (this.viewMode) {
                    case 0:
                        this.o.startDate !== -1 / 0 && e <= this.o.startDate.getUTCFullYear() && i <= this.o.startDate.getUTCMonth()
                            ? this.picker.find(".prev").css({ visibility: "hidden" })
                            : this.picker.find(".prev").css({ visibility: "visible" }),
                            1 / 0 !== this.o.endDate && e >= this.o.endDate.getUTCFullYear() && i >= this.o.endDate.getUTCMonth()
                                ? this.picker.find(".next").css({ visibility: "hidden" })
                                : this.picker.find(".next").css({ visibility: "visible" });
                        break;
                    case 1:
                    case 2:
                        this.o.startDate !== -1 / 0 && e <= this.o.startDate.getUTCFullYear() ? this.picker.find(".prev").css({ visibility: "hidden" }) : this.picker.find(".prev").css({ visibility: "visible" }),
                            1 / 0 !== this.o.endDate && e >= this.o.endDate.getUTCFullYear() ? this.picker.find(".next").css({ visibility: "hidden" }) : this.picker.find(".next").css({ visibility: "visible" });
                }
            }
        },
        click: function (e) {
                    ...
                    case "span":
                        r.is(".disabled") ||
                            ...
                            r.is(".month")
                                ...
                                : ((n = 1), (s = 0), (a = parseInt(r.text(), 10) || 0), this.viewDate.setUTCFullYear(a), this._trigger("changeYear", this.viewDate), 2 === this.o.minViewMode && this._setDate(i(a, s, n))),
                            this.showMode(-1),
                            this.fill());
                        break;
                    case "td":
                        r.is(".day") &&
                            ...
                            (a = this.viewDate.getUTCFullYear()),
                            (s = this.viewDate.getUTCMonth()),
                            r.is(".old") ? (0 === s ? ((s = 11), (a -= 1)) : (s -= 1)) : r.is(".new") && (11 === s ? ((s = 0), (a += 1)) : (s += 1)),
        ...
        keydown: function (t) {
            ...
            switch (t.keyCode) {
                ...
                case 39:
                    ...
                    (e = 37 === t.keyCode ? -1 : 1),
                        t.ctrlKey
                            ? ((i = this.moveYear(this.dates.get(-1) || a(), e)), (s = this.moveYear(r, e)), this._trigger("changeYear", this.viewDate))
                            : t.shiftKey
                            ? ((i = this.moveMonth(this.dates.get(-1) || a(), e)), (s = this.moveMonth(r, e)), this._trigger("changeMonth", this.viewDate))
                            : ((i = new Date(this.dates.get(-1) || a())), i.setUTCDate(i.getUTCDate() + e), (s = new Date(r)), s.setUTCDate(r.getUTCDate() + e)),
                        this.dateWithinRange(i) && ((this.focusDate = this.viewDate = s), this.setValue(), this.fill(), t.preventDefault());
                    break;
                case 38:
                case 40:
                    if (!this.o.keyboardNavigation) break;
                    (e = 38 === t.keyCode ? -1 : 1),
                        t.ctrlKey
                            ...
                            : t.shiftKey
                            ? ((i = this.moveMonth(this.dates.get(-1) || a(), e)), (s = this.moveMonth(r, e)), this._trigger("changeMonth", this.viewDate))
                            : ((i = new Date(this.dates.get(-1) || a())), i.setUTCDate(i.getUTCDate() + 7 * e), (s = new Date(r)), s.setUTCDate(r.getUTCDate() + 7 * e)),
                        this.dateWithinRange(i) && ((this.focusDate = this.viewDate = s), this.setValue(), this.fill(), t.preventDefault());
                    break;
                case 32:
                    break;
